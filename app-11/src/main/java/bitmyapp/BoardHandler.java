...
public class BoardHandler {
  ...
  void modifyBoard() {
    ...
    b.setTitle(Prompt.inputString(String.format("이름(%s)", old.getTitle())));
    b.setContent(Prompt.inputString(String.format("전화(%s)", old.getContent())));
    b.setPassword(Prompt.inputString("암호? "));
  ...
  void deleteBoard() {
    ...
    this.boards[--this.count] = null; // 레퍼런스의 카운트를 줄인다.
