...
import bitmyapp.handler.BoardHandler;
import bitmyapp.handler.MemberHandler;
...
public class App {
  ...
  private static void goMainMenu() {
    ...
    MemberHandler supportMemberHandler = new MemberHandler("국비지원학생");
